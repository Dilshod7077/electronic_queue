...
<div class="panel-primary">
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-12 shadowed">
            <div class="btn btn-primary col-lg-2 col-md-4 col-sm-6 col-xs-12">
                <div class="p-1">
                    ...
                    <h5>{{ trans('app.department') }} {{ (isset($infobox->department)?$infobox->department:0) }}</h5>
                </div>
            </div>
            <div class="btn btn-primary col-lg-2 col-md-4 col-sm-6 col-xs-12">
                <div class="p-1">
            ...
            <div class="btn btn-warning  col-lg-2 col-md-4 col-sm-6 col-xs-12">
                <div class="p-1">
                    <i class="fa fa-ticket fa-2x"></i>
                    <h5>{{ (isset($infobox->token->pending)?$infobox->token->pending:0) }} {{ trans('app.pending') }} {{ trans('app.token') }}</h5>
                </div>
            </div>
            <div class="btn btn-info col-lg-2 col-md-4 col-sm-6 col-xs-12">
                <div class="p-1">
                    <i class="fa fa-ticket fa-2x"></i>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="panel-primary shadowed">
                    <div class="panel-heading">{{ trans('app.this_month') }}</div>
                    <div class="panel panel-body"><canvas id="lineChart"></canvas></div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="panel-primary shadowed">
                    ...
                    <div class="panel panel-body"><canvas id="singelBarChart" style="height:200px"></canvas></div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="panel-primary shadowed mb-3">
                    <div class="panel-heading">{{ trans('app.from_the_begining') }}</div>
                    <div class="panel panel-body"><canvas id="pieChart" style="height:200px"></canvas></div>
                </div>
            </div>
        </div>
    </div>
