                    ...
                    <div class="popover cm-popover bottom">
                        ...
                        <div class="popover-content">
                            <div class="list-group">
                                ...
                                <a href="javascript:void(0)" data-locale="ru" class="select-lang list-group-item {{ (Session::get('locale')=='ru'?'active':'') }}">
                                    <h4 class="list-group-item-heading"></i> Русский</h4>
                                </a>
                                <a href="javascript:void(0)" data-locale="tj" class="select-lang list-group-item {{ (Session::get('locale')=='tj'?'active':'') }}">
                                    <h4 class="list-group-item-heading"></i> Tоҷикӣ</h4>
                                </a>
                            </div>
                        </div>
                    </div>
